<div id="content-single" class="content group">
    <div class="hentry hentry-post blog-big group ">
        ...
        <div class="meta group">
            ...
            <p class="categories"><span>In: <a href="{{route('articlesCat', ['cat_alias' => $article->category->alias])}}" title="{{$article->category->title}}" rel="category tag">{{$article->category->title}}</a>
            <p class="comments"><span><a href="#comments" title="Comment on This is the title of the first article. Enjoy it.">{{count($article->comments) ? count($article->comments) : '0'}} {{\Illuminate\Support\Facades\Lang::choice('ru.comments', count($article->comments))}}</a></span></p>
        </div>
        <!-- post content -->
    ...
    <div id="comments">
        ...
        <ol class="commentlist group">
            <li class="comment even depth-1">
                <div class="comment-container">
                    <div class="comment-author vcard">
                        <img alt="" src="../../public/pink/images/avatar/unknow.png" class="avatar" height="75" width="75" />
            ...
            <li class="comment bypostauthor odd">
                <div class="comment-container">
                    <div class="comment-author vcard">
                        <img alt="" src="../../public/pink/images/avatar/nicola.jpeg" class="avatar" height="75" width="75" />
