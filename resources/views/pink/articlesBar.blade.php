                ...
                @foreach($portfolios as $portfolio)
                    <div class="hentry-post group">
                        ...
                        <div class="text">
                            ...
                            <a class="read-more" href="{{route('portfolios.show', ['alias' => $portfolio->alias])}}">&rarr; {{\Illuminate\Support\Facades\Lang::get('ru.read_more')}}</a>
                        </div>
                    </div>
                @endforeach
            @endif
    ...
    <div class="widget-last widget recent-comments">
        ...
        <div class="recent-post recent-comments group">
            ...
            <div class="the-post group">
                <div class="avatar">
                    <img alt="" src="../../public/pink/images/avatar/unknow55.png" class="avatar" />
                </div>
            ...
            <div class="the-post group">
                <div class="avatar">
                    <img alt="" src="../../public/pink/images/avatar/nicola55.jpeg" class="avatar" />
                </div>
